...
const extractCode = [
  ...
  "",
  "if (!state.major) {",
  "  if (text.includes('ป.โท') || text.includes('ปริญญาโท') || text.includes('บริหารการศึกษา')) state.major = 'ป.โท';",
  "  else if (text.includes('ป.เอก') || text.includes('ปริญญาเอก')) state.major = 'ป.เอก';",
  "  else if (text.includes('ป.บัณฑิต') || text.includes('บัณฑิตวิชาชีพครู')) state.major = 'ป.บัณฑิต';",
  "  else if (text.includes('นิติ')) state.major = 'นิติศาสตร์';",
