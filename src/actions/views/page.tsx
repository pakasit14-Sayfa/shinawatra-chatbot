...
import type { HomeLocale } from '@/data/home/content'
import { homeCopy, homeLocales } from '@/data/home/content'
...
const SelectSessionPage = () => {
  ...
  const params = useParams<{ lang: HomeLocale }>()
  const lang = (params?.lang ?? 'th') as HomeLocale

  const copy = homeCopy[lang] ?? homeCopy.en

  // hero background — ให้เหมือนหน้าแรก (Punch เซ็ตไฟล์รูปตามที่ใช้ในหน้าแรกได้)
  const heroBg = '/images/front-pages/landing-page/up-campus-bg.jpg'

  const handleEdit = () => {
    router.push(getLocalizedUrl('/', lang as Locale))
  }
  ...
  const handleLogout = () => {
    router.push(getLocalizedUrl('/login', lang as Locale))
  }
          ...
          >
            <Stack direction='row' spacing={1.5} alignItems='center' flexWrap='wrap'>
              ...
              <Divider
                ...
                flexItem
                sx={{ borderColor: alpha(theme.palette.common.white, 0.4) }}
              />
              <Button component={Link} href={getLocalizedUrl('/', lang as Locale)} color='inherit'>
                {copy.nav.home}
              </Button>
              <Button
                component='a'
              ...
              <Button
                component={Link}
                href={getLocalizedUrl('/login', lang as Locale)}
                color='inherit'
              ...
              <Stack direction='row' spacing={0.5} alignItems='center'>
                {homeLocales.map(language => (
                  <Chip
                    ...
                    component={Link}
                    href={getLocalizedUrl('/', language as Locale)}
                    clickable
      ...
      <Container maxWidth='lg' sx={{ mt: { xs: -8, md: -10 }, pb: 10 }}>
        ...
        >
          ...
          >
            ...
            {/* ปุ่มแก้ไขข้อมูล – สไตล์เหมือนปุ่มเพิ่มรายชื่อหน้าแรก */}
            <Button
              variant='contained'
              color='primary'
              onClick={handleEdit}
          ...
          <Stack
            ...
            alignItems={{ xs: 'stretch', md: 'center' }}
          >
            {/* ปุ่มพิมพ์ – ใช้สไตล์ pill + shadow แบบเดียวกัน */}
            <Button
              variant='contained'
              color='primary'
              onClick={handlePrint}
            ...
            {/* ปุ่มออกจากระบบ – ทำให้มนเหมือนกัน */}
            <Button
              variant='outlined'
              color='secondary'
